...
export const FinanceProvider = ({ children }) => {
  ...
  const filteredTransactions = useMemo(() => {
    ...
    if (filters.sortBy === "date-desc") list.sort((a, b) => new Date(b.date) - new Date(a.date));
    else if (filters.sortBy === "date-asc") list.sort((a, b) => new Date(a.date) - new Date(b.date));
    else if (filters.sortBy === "amount-desc") list.sort((a, b) => b.amount - a.amount);
    else if (filters.sortBy === "amount-asc") list.sort((a, b) => a.amount - b.amount);
    return list;
  ...
  return (
    <FinanceContext.Provider value={{
      ...
      darkMode, setDarkMode, searchQuery, setSearchQuery,
      filters, setFilters, activeSection, setActiveSection,
